...
// callbackIntervalMs: 回调间隔（毫秒），iOS/鸿蒙平台用于控制多少毫秒回调一次，Android 通过 samplingRate 控制，会忽略此参数
data class SensorConfig(
    ...
    companion object {
        ...
        // 扭动互动使用 GyroscopeAngleTracker 对 Z 轴角速度积分，宿主侧需保证回调包含 z。
        val TWIST_INTERACT = SensorConfig(
            monitorAxes = setOf(SensorAxis.Z),
            samplingRate = SensorSamplingRate.UI,
            callbackIntervalMs = 16L
        )
    }
}
