...
object AppHost {
    ...
    const val RELEASE_WRITE_HOST = "https://w.inews.qq.com/"
    const val DEV_HOST = "https://dev.inews.qq.com/"

    var READ_HOST = RELEASE_HOST
    var WRITE_HOST = RELEASE_WRITE_HOST
...
data class NetworkBuilder<T> constructor(
    var url: String,
...
abstract class SameImplNetwork : INetwork {
    ...
    final override fun <T> streamPostRequest(builder: NetworkBuilder<T>) = defaultRequestImpl(builder)
}
