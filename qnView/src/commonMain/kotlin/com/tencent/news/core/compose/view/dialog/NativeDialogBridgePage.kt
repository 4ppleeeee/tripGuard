...
import com.tencent.news.core.compose.scaffold.dialog.PopupDialogState
 ...
 */
@Page(name = ComposeViewKey.Dialog.NATIVE_BRIDGE)
internal class NativeDialogBridgePage : PopUpDialog() {
    ...
    /**
     * 设置背景颜色为透明，否则 NativeBridgeDialog 的默认背景色和 Compose 的 dialog 背景色会叠加，在鸿蒙端表现卡顿
     */
    override val getBackgroundColor: ((state: PopupDialogState) -> Color) = {
        Color.Transparent
    }
