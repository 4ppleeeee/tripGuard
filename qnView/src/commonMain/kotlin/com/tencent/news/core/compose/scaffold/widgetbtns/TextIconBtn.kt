            ...
            Column(
                modifier = Modifier
                    .dtElement(
                        ...
                        enableExposure = true,
                        elementParams = vm.dtElementParams
                    )
 ...
 */
@Composable
private fun TextWithIcon(text: String, iconFont: IconFont, size: StructSize) {
    Row(
        modifier = Modifier,
...
@Composable
private fun TextIconFont(iconFont: IconFont, size: StructSize) {
    QnIconFont(
        name = iconFont,
        textStyle = TextStyle(
            color = currentTitleBarTheme.widgetFgColor,
