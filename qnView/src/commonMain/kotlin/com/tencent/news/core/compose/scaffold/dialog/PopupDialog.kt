...
abstract class PopUpDialog : ComposeDialog() {
    ...
    open val dismissOnBackgroundClick: Boolean = true

    @Composable
    open fun getForceProtectClickEvent(): Boolean? = forceProtectClickEvent

    @Composable
    open fun getDismissOnBackgroundClick(): Boolean = dismissOnBackgroundClick
    ...
    override fun OnSetContent() {
        ...
        PopUpDialog(
            ...
            forceProtectClickEvent = getForceProtectClickEvent(),
            dismissOnBackgroundClick = getDismissOnBackgroundClick(),
            content = {
