package com.tencent.news.markdown.compose.components
...
import com.tencent.news.markdown.compose.elements.MarkdownBlockQuote
import com.tencent.news.markdown.compose.elements.MarkdownBulletList
import com.tencent.news.markdown.compose.elements.MarkdownCheckBox
import com.tencent.news.markdown.compose.elements.MarkdownCodeBlock
import com.tencent.news.markdown.compose.elements.MarkdownCodeFence
import com.tencent.news.markdown.compose.elements.MarkdownDivider
import com.tencent.news.markdown.compose.elements.MarkdownHeader
import com.tencent.news.markdown.compose.elements.MarkdownImage
import com.tencent.news.markdown.compose.elements.MarkdownOrderedList
import com.tencent.news.markdown.compose.elements.MarkdownParagraph
import com.tencent.news.markdown.compose.elements.MarkdownTable
import com.tencent.news.markdown.compose.elements.MarkdownText
import com.tencent.news.markdown.compose.elements.listDepth
...
fun markdownComponents(
    ...
    video: MarkdownComponent = CurrentComponentsBridge.video,
    ...
    html: MarkdownComponent = CurrentComponentsBridge.html,
...
private class DefaultMarkdownComponents(
    ...
    override val video: MarkdownComponent,
    @Deprecated("The lookup of link definitions is now handled by the parser. It is advised to use the new API. This will be removed in a future version.")
    ...
    override val html: MarkdownComponent,
...
internal object CurrentComponentsBridge {
    ...
    val linkDefinition: MarkdownComponent = {
        ...
        if (linkLabel != null) {
            val destination =
                it.node.findChildOfType(MarkdownElementTypes.LINK_DESTINATION)
                    ?.getUnescapedTextInNode(it.content)
