...
class PostShareDialog(
    ...
    private val shareDtParams: ShareDtParams = ShareDtParams(QnViewDtElementIds.ShareCardPanel),
            ...
            Column(
                ...
                Column(
                    ...
                    LazyColumn(
                        ...
                        item {
                            val screenshotContainerModifier = widthModifier.wrapContentHeight()
            ...
            val dialogContent: @Composable () -> Unit = {
                Column(
                    modifier = Modifier
                        ...
                        .fillMaxHeight()
                        .dtElement(
                            elementId = QnViewDtElementIds.SharePanel,
                            elementParams = elementParams,
                            enableExposure = true,
                            logicParentView = logicParent
