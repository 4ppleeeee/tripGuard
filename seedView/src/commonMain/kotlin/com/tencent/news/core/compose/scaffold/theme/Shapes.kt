...
data class Shapes(
    ...
    val topMedium: RoundedCornerShape = RoundedCornerShape(topStart = 12.dp, topEnd = 12.dp),
    val startMedium: RoundedCornerShape = RoundedCornerShape(topStart = 12.dp, bottomStart = 12.dp),
