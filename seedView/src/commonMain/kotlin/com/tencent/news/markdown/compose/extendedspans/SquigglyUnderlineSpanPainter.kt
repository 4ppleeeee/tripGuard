...
import com.tencent.kuikly.compose.ui.text.style.TextDecoration.Companion.LineThrough
import com.tencent.kuikly.compose.ui.text.style.TextDecoration.Companion.None
import com.tencent.kuikly.compose.ui.text.style.TextDecoration.Companion.Underline
...
import com.tencent.news.markdown.compose.extendedspans.internal.colorOrNull
import com.tencent.news.markdown.compose.extendedspans.internal.deserializeToColor
import com.tencent.news.markdown.compose.extendedspans.internal.fastMapRange
 ...
 */
internal class SquigglyUnderlineSpanPainter(
    ...
    override fun decorate(
        ...
        val updatedTextLinkStyles =
            linkAnnotation.styles?.update { copy(textDecoration = if (LineThrough in textDecoration) LineThrough else None) }
    ...
    override fun drawInstructionsFor(layoutResult: TextLayoutResult, color: Color?): SpanDrawInstructions {
        ...
        return SpanDrawInstructions {
            ...
            annotations.fastForEach { annotation ->
                ...
                val textColor = annotation.item.deserializeToColor()
                    ?: layoutResult.layoutInput.style.color.colorOrNull()
                    ?: color
                    ?: Color.Unspecified
...
@Composable
internal fun rememberSquigglyUnderlineAnimator(duration: Duration = 1.seconds): SquigglyUnderlineAnimator {
