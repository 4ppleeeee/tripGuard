...
interface IAppEncoder {
    ...
    fun cipherAESEncrypt(key: ByteArray, iv: ByteArray, data: ByteArray): ByteArray

    fun cipherAESDecrypt(key: ByteArray, iv: ByteArray, data: ByteArray): ByteArray
    ...
    fun rsaEncryptBase64(data: ByteArray, publicKey: String): String = ""
