...
interface IResManager {
    ...
    // 保存本地视频到系统相册
    fun saveVideo(localFilePath: String): Boolean

    // 保存网络视频到系统相册，具体下载/落盘策略由宿主实现。
    fun saveVideo(
        url: String,
        taskId: String? = null,
     ...
     * 打开系统相册选图
     */
    fun selectImage(context: IKmmContext?, callback: (url: List<String>) -> Unit)
