...
internal actual fun getDefaultPlatformLogic(): IPlatformLogic? = IOSPlatformLogic

private object IOSPlatformLogic : IPlatformLogic {
    ...
    override val network: INetwork?
        get() = null
    override val appPageStack: IAppPageStack = IOSAppPageStack()
