...
import com.tencent.news.core.list.extension.bindCtxDtoBase
...
internal class FlexibleFeedsController(
    ...
    private fun bindCtxDtoData(allData: List<IKmmFeedsItem>, newsData: List<IKmmFeedsItem>, requestEnv: FeedsRequestEnv) {
        ...
        allData.bindCtxDtoBase { newsChannel = channelEnv.newsChannel }
        ...
        allData.bindCtxDtoBase { pageBusinessType = rootWidget.data?.business_type }
