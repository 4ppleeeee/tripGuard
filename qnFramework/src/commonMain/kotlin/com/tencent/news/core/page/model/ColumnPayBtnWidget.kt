...
// 【付费专栏】购买按钮
@Serializable
@SerialName(StructWidgetType.COLUMN_PAY_BTN)
open class ColumnPayBtnWidget : StructBtnWidget<ColumnPayBtnWidgetData>() {
    ...
    override fun getWidgetType() = StructWidgetType.COLUMN_PAY_BTN
...
class ColumnPayBtnWidgetDataWrapperSerializer : DataWrapperSerializer<ColumnPayBtnWidgetData>(
    StructWidgetType.COLUMN_PAY_BTN, ColumnPayBtnWidgetData.serializer()
)