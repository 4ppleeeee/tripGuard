...
enum class DtPageId(val id: String) {

    GAME_HALL("pg_game_hall"),                      // BonBong游戏首页
    MINI_GAME_HALL("pg_mini_game_hall"),            // 小游戏首页
    ...
    PG_RADIO_LIST("pg_radio_list"),                  // 电台频道列表页

    HOT_CP("pg_hot_cp"),                           // 热门作者页
    ...
    PG_COIN_CENTER("pg_coin_center"),                       // 金币中心
    PG_TASK_CENTER("pg_task_center"),                       // 积分任务中心

    PG_ALBUM("pg_album"),                                   // 视频专栏底层页 / 合集底层页
}
