...
class PopTaskBuilder {
    ...
    private var deferredShowValidator: PopDeferredShowValidator? = null
    private var queueObserver: PopQueueObserver? = null
    ...
    fun setDeferredShowValidator(validator: PopDeferredShowValidator): PopTaskBuilder {
        this.deferredShowValidator = validator
        return this
    }

    fun setQueueObserver(observer: PopQueueObserver): PopTaskBuilder {
    ...
    fun build(): KmmPopTask {
        ...
        return KmmPopTask(
            ...
            deferredShowValidator = this.deferredShowValidator,
