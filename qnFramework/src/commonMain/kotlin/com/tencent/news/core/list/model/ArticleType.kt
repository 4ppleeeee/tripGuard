...
object ArticleType : IListEnumDoc {
    ...
    const val VIDEO_LIVE: String = "110" // 直播，包括直播中和回放，具体区分使用LiveReportUtil#getType()
    const val VIDEO_PGC: String = "111" // 点播
    ...
    const val CP_RECOMMEND = "209"          // 【创服】CP推荐
    ...
    const val TV_CATEGORY_ENTRY = "570"     // 长视频频道分类入口(Tv长视频分类入口)
    ...
    const val ARTICLETYPE_THING_HEADER_FORBID_JUMP = "356" // 二改事件底层页头部不允许跳转的文章类型
    ...
    const val EVENT_TIMESLIDER = "730"      // 横滑时间轴
    ...
    const val MINI_GAME_HALL_PAGE = "7002"  // BonBon小游戏首页（上报用）
