...
@Serializable
@SerialName(QnCoreStructWidgetType.FAVORITE_BTN)
open class FavoriteBtnWidget : StructBtnWidget<FavoriteBtnWidgetData>() {
    ...
    override fun getWidgetType() = QnCoreStructWidgetType.FAVORITE_BTN
}
...
class FavoriteBtnWidgetDataWrapperSerializer : DataWrapperSerializer<FavoriteBtnWidgetData>(
    QnCoreStructWidgetType.FAVORITE_BTN, FavoriteBtnWidgetData.serializer()
)
