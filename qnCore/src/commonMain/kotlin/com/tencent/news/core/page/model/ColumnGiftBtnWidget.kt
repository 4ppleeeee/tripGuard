...
@Serializable
@SerialName(QnCoreStructWidgetType.COLUMN_GIFT_BTN)
class ColumnGiftBtnWidget : StructBtnWidget<ColumnGiftBtnWidgetData>() {
    ...
    override fun getWidgetType() = QnCoreStructWidgetType.COLUMN_GIFT_BTN
...
class ColumnGiftBtnWidgetDataWrapperSerializer : DataWrapperSerializer<ColumnGiftBtnWidgetData>(
    QnCoreStructWidgetType.COLUMN_GIFT_BTN, ColumnGiftBtnWidgetData.serializer()
)
