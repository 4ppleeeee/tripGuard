...
@Serializable
@SerialName(QnCoreStructWidgetType.EMOJI_BTN)
open class EmojiBtnWidget : StructBtnWidget<EmojiBtnWidgetData>() {
    ...
    override fun getWidgetType() = QnCoreStructWidgetType.EMOJI_BTN
}
...
class EmojiBtnWidgetDataWrapperSerializer : DataWrapperSerializer<EmojiBtnWidgetData>(
    QnCoreStructWidgetType.EMOJI_BTN, EmojiBtnWidgetData.serializer()
)
